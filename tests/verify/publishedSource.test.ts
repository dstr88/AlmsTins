...
// DATABASE_URL (pg became the default engine in 64b74d1). The analyzer is pure
// but reaches it via verifyPublishedSource.ts -> verifyRegistry.ts -> '@/lib/db',
// so stub the client: this suite needs no database, and any query throws.
vi.mock('@/lib/db', () => {
