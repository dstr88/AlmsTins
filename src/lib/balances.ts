...
const TRACKED_TOKENS: Record<SupportedChain, ChainToken[]> = {
	ethereum: [
		...
		{ symbol: 'WETH', type: 'erc20', contractAddress: '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2', decimals: 18, coingeckoId: 'weth' },
		{ symbol: 'WBTC', type: 'erc20', contractAddress: '0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599', decimals: 8, coingeckoId: 'wrapped-bitcoin' },
		{ symbol: 'USDC', type: 'erc20', contractAddress: '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48', decimals: 6, coingeckoId: 'usd-coin' },
		{ symbol: 'USDT', type: 'erc20', contractAddress: '0xdAC17F958D2ee523a2206206994597C13D831ec7', decimals: 6, coingeckoId: 'tether' },
		{ symbol: 'DAI', type: 'erc20', contractAddress: '0x6B175474E89094C44Da98b954EedeAC495271d0F', decimals: 18, coingeckoId: 'dai' },
		{ symbol: 'LINK', type: 'erc20', contractAddress: '0x514910771AF9Ca656af840dff83E8264EcF986CA', decimals: 18, coingeckoId: 'chainlink' },
	],
	polygon: [
		{ symbol: 'MATIC', type: 'native', decimals: 18, coingeckoId: 'matic-network' },
		{ symbol: 'WETH', type: 'erc20', contractAddress: '0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619', decimals: 18, coingeckoId: 'weth' },
		{ symbol: 'WBTC', type: 'erc20', contractAddress: '0x1BFD67037B42Cf73acF2047067bd4F2C47D9BfD', decimals: 8, coingeckoId: 'wrapped-bitcoin' },
		{ symbol: 'USDC', type: 'erc20', contractAddress: '0x2791Bca1f2de4661ED88A30C99A7a9449Aa84174', decimals: 6, coingeckoId: 'usd-coin' },
		{ symbol: 'USDT', type: 'erc20', contractAddress: '0xc2132D05D31c914a87C6611C10748AEb04B58e8F', decimals: 6, coingeckoId: 'tether' },
		{ symbol: 'DAI', type: 'erc20', contractAddress: '0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063', decimals: 18, coingeckoId: 'dai' },
		{ symbol: 'LINK', type: 'erc20', contractAddress: '0x53E0bCA35eC356BD5DdDFebbD1Fc0fD03FAb1eDf', decimals: 18, coingeckoId: 'chainlink' },
		// POL / wPOL can be added later once enabled
	],
	avalanche: [
		{ symbol: 'AVAX', type: 'native', decimals: 18, coingeckoId: 'avalanche-2' },
		{ symbol: 'WAVAX', type: 'erc20', contractAddress: '0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7', decimals: 18, coingeckoId: 'wrapped-avax' },
		{ symbol: 'USDC', type: 'erc20', contractAddress: '0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E', decimals: 6, coingeckoId: 'usd-coin' },
		{ symbol: 'USDT.e', type: 'erc20', contractAddress: '0xde3A24028580884448a5397872046a019649b084', decimals: 6, coingeckoId: 'tether' },
		{ symbol: 'DAI.e', type: 'erc20', contractAddress: '0xd586E7F844cEa2F87f50152665BCbc2C279D8d70', decimals: 18, coingeckoId: 'dai' },
		{ symbol: 'LINK.e', type: 'erc20', contractAddress: '0x5947BB275c521040051D82396192181b413227A3', decimals: 18, coingeckoId: 'chainlink' },
		{ symbol: 'WETH', type: 'erc20', contractAddress: '0x49d5c2bdffac6ce2bfdb6640f4f80f226bc10bab', decimals: 18, coingeckoId: 'weth' }, // WETH.e
		{ symbol: 'WBTC', type: 'erc20', contractAddress: '0x50b7545627a5162f82a992c33b87adc75187b218', decimals: 8, coingeckoId: 'wrapped-bitcoin' }, // WBTC.e
	],
};
	...
	for (const token of tokens) {
		if (chain === 'ethereum') {
			...
			balances.push({
				...
				decimals: token.decimals,
				rawBalance: toBigInt(payload.amount.toString()),
			});
			continue;
		}
...
async function safeFetchEthereumTokenBalance(opts: {
	...
	const { address, contractAddress, symbol, decimals } = opts;
	try {
		...
		// Soft-fail: pretend this token is zero instead of throwing
		return {
			symbol,
			tokenAddress: contractAddress,
			amount: 0,
