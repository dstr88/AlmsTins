...
export const en: VerifyDashboardLocale = {
  ...
  notice: "Almstins Verify is in beta — and free. You're welcome to register up to 3 destinations, and one of them can be a payment QR code instead of a wallet address (so: 2 wallets + 1 QR). They're held privately under your account.",
  ...
  addErrNameTaken: 'That business name is already taken. Choose a different name.',
...
export const es: VerifyDashboardLocale = {
  ...
  notice: 'Almstins Verify está en beta — y es gratis. Puedes registrar hasta 3 destinos, y uno de ellos puede ser un código QR de pago en lugar de una dirección de billetera (es decir: 2 billeteras + 1 QR). Se guardan de forma privada en tu cuenta.',
  ...
  addErrNameTaken: 'Ese nombre de negocio ya está en uso. Elige un nombre diferente.',
...
export const fr: VerifyDashboardLocale = {
  ...
  notice: 'Almstins Verify est en bêta — et gratuit. Vous pouvez enregistrer jusqu’à 3 destinations, et l’une d’elles peut être un QR code de paiement au lieu d’une adresse de portefeuille (soit : 2 portefeuilles + 1 QR). Elles restent privées sur votre compte.',
  ...
  addErrNameTaken: 'Ce nom d’entreprise est déjà pris. Choisissez un autre nom.',
