...
export const POST: APIRoute = async ({ params, request }) => {
	...
	// Add to whitelist and remove from blacklist atomically
	await Promise.all([
		db.execute({
			sql: `INSERT INTO nft_whitelist (tenant_id, wallet_id, chain_id, contract_address, token_id)
				VALUES (?, ?, ?, ?, ?)
